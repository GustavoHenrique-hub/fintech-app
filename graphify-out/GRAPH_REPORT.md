# Graph Report - fintech-app  (2026-08-14)

## Corpus Check
- 345 files · ~110,454 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2004 nodes · 4008 edges · 200 communities (117 shown, 83 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 184 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9dd7381a`
...
Cohesion: 0.15
Nodes (10): CallbackExtratoRequestDTO, LancamentoDTO, LancamentoProcessado, ResultadoProcessamentoExtrato, ExtendWith, Test, RegistrarResultadoExtratoUseCaseTest, ConfirmarRevisaoTransacaoUseCaseTest (+2 more)
...
Cohesion: 0.13
Nodes (4): BeanConfig, Bean, Configuration, CategoriaRepositoryPort
...
Cohesion: 0.10
Nodes (17): AuthController, ApiResponse, Operation, PostMapping, RequestMapping, ResponseEntity, RestController, Tag (+9 more)
...
Cohesion: 0.09
Nodes (12): AtualizarStatusExtratoUseCase, Transactional, BuscarExtratoUseCase, CriarExtratoUseCase, ListarExtratosUseCase, Transactional, RemoverExtratoUseCase, ExtratoInvalidoException (+4 more)
...
Cohesion: 0.22
Nodes (7): ExtratoParser, ImportarExtratoUseCase, Transactional, SolicitacaoProcessamentoExtrato, ArmazenamentoArquivoPort, ProcessamentoExtratoPort, BeforeEach
...
Cohesion: 0.23
Nodes (8): Component, Override, Pattern, SessaoTokenFilter, FilterChain, HttpServletRequest, HttpServletResponse, OncePerRequestFilter
...
Cohesion: 0.33
Nodes (3): ImportarExtratoUseCaseTest, ExtendWith, Test
...
Cohesion: 0.06
Nodes (28): BuscarContaFinanceiraUseCase, CriarContaFinanceiraUseCase, ListarContasFinanceirasUseCase, Transactional, RemoverContaFinanceiraUseCase, ContaFinanceiraInvalidaException, ContaFinanceira, Getter (+20 more)
...
Cohesion: 0.09
Nodes (10): ResumoPeriodoResponseDTO, BuscarResumoPeriodoUseCase, BuscarTransacaoUseCase, EstornarTransacaoUseCase, ListarTransacoesUseCase, ResumoPeriodo, TransacaoRepositoryPort, ExtendWith (+2 more)
...
Cohesion: 0.25
Nodes (3): Logger, Transactional, RegistrarResultadoExtratoUseCase
...
Cohesion: 0.26
Nodes (5): CriarTransacaoUseCase, Transactional, CriarTransacaoUseCaseTest, ExtendWith, Test
...
Cohesion: 0.13
Nodes (14): OrigemTransacao, api, importado, manual, pdf, StatusRevisaoTransacao, ARQUIVADA, CLASSIFICADA (+6 more)

### Community 203 - "TipoTransacao"
Cohesion: 0.10
Nodes (13): ConfirmarRevisaoTransacaoUseCase, Transactional, Transactional, DestinoRevisaoLancamento, ECONOMIA, GASTO, RECEITA, TipoTransacao (+5 more)

## Knowledge Gaps
- **400 isolated node(s):** `points`, `com.enterprise.gustadev:fintech_app`, `CREATE`, `UPDATE`, `DELETE` (+395 more)
...
- **Why does `ExtratoInvalidoException` connect `Extrato Repository Port & Related` to `ListarContasFinanceirasUseCase`, `GlobalExceptionHandler.java`, `StatusRevisaoTransacao`, `TransacaoCanceladaController.java`, `TipoTransacao`, `Transacao Repository Port & Related`, `CriarTransacaoUseCaseTest.java`, `Extrato Controller & Related`, `VincularBancoModal.jsx`, `ListarTransacoesUseCaseTest.java`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `ContaFinanceiraRepositoryPort` connect `CriarTransacaoUseCaseTest.java` to `Tipo Conta`, `Categoria Repository Port & Related`, `Bean Config`, `Transactional`, `Extrato Repository Port & Related`, `StatusRevisaoTransacao`, `Transacao Cancelada Repository Port & Related`, `Mock Mvc`, `TipoTransacao`, `Tipo Job`, `Transacao Repository Port & Related`, `Notificacao`, `ListarTransacoesUseCaseTest.java`, `ImportarExtratoUseCase.java`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `ContaFinanceira` connect `CriarTransacaoUseCaseTest.java` to `Tipo Conta`, `Conta Financeira Controller Test`, `Categoria Repository Port & Related`, `Transactional`, `StatusRevisaoTransacao`, `Mock Mvc`, `TipoTransacao`, `Tipo Job`, `Transacao Repository Port & Related`, `Conta Financeira Controller & Related`, `ImportarExtratoUseCase.java`?**
