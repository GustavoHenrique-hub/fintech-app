...
## Summary
- 1923 nodes · 3389 edges · 226 communities (125 shown, 101 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 130 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0b063f41`
...
1. `apiUnwrap()` - 66 edges
2. `ContaFinanceira` - 48 edges
3. `ContaFinanceiraRepositoryPort` - 48 edges
4. `BeanConfig` - 39 edges
5. `Transacao` - 38 edges
6. `TransacaoRepositoryPort` - 34 edges
7. `api` - 29 edges
8. `ContaFinanceiraInvalidaException` - 26 edges
9. `Categoria` - 25 edges
10. `Extrato` - 23 edges
...
## Communities (226 total, 101 thin omitted)
...
Cohesion: 0.07
Nodes (40): api, apiUnwrap(), login(), buscarPorChave(), listar(), criar(), buscarPorChave(), listarPadrao() (+32 more)

### Community 3 - "Bean Config"
Cohesion: 0.05
Nodes (53): BeanConfig, BuscarExtratoUseCase, CategoriaRepositoryPort, ContaFinanceiraRepositoryPort, CriarExtratoUseCase, ExtratoRepositoryPort, ListarExtratosUseCase, RemoverExtratoUseCase (+45 more)
...
Cohesion: 0.17
Nodes (13): AuthController, ApiResponse, Operation, PostMapping, RequestMapping, ResponseEntity, RestController, Tag (+5 more)

### Community 6 - "Usuario Controller & Related"
Cohesion: 0.12
Nodes (9): BuscarUsuarioUseCase, CriarUsuarioUseCase, ListarUsuariosUseCase, SenhaEncoder, UsuarioInvalidoException, Getter, Setter, Usuario (+1 more)

### Community 7 - "Extrato Repository Port & Related"
Cohesion: 0.15
Nodes (7): BuscarExtratoUseCase, ListarExtratosUseCase, Transactional, RemoverExtratoUseCase, ExtratoInvalidoException, Extrato, ExtratoRepositoryPort

### Community 8 - "Cadastro Page & Related"
Cohesion: 0.07
Nodes (26): FinSight Overview Static HTML Mockup, Frontend index.html React Mount Point, App(), BalanceChart(), buildPoints(), buildPointsDiario(), buildPointsMensal(), DIAS_LABEL (+18 more)
...
Cohesion: 0.16
Nodes (7): OrigemTransacao, api, importado, manual, pdf, TransacaoNaoEncontradaException, ExtendWith
...
Cohesion: 0.17
Nodes (9): Transactional, Getter, Setter, TipoConta, cartao, corrente, dinheiro, investimento (+1 more)

### Community 16 - "Extrato Controller & Related"
Cohesion: 0.20
Nodes (18): ApiResponse, ApiResponses, ExtratoController, BuscarExtratoUseCase, CriarExtratoUseCase, ListarExtratosUseCase, RemoverExtratoUseCase, ResponseEntity (+10 more)
...
Cohesion: 0.09
Nodes (23): EconomiaRequestDTO, Schema, Schema, MovimentacaoEconomiaResponseDTO, EconomiaController, ApiResponse, ApiResponses, GetMapping (+15 more)
...
Cohesion: 0.11
Nodes (14): DetectorFormatoExtrato, ExtratoParsingUtils, Pattern, Component, Override, Pattern, PdfExtratoParser, FormatoExtrato (+6 more)
...
Cohesion: 0.22
Nodes (11): ImportarExtratoUseCaseTest, Categoria, CategoriaRepositoryPort, ContaFinanceira, ContaFinanceiraRepositoryPort, ExtratoRepositoryPort, Test, TransacaoRepositoryPort (+3 more)
...
Cohesion: 0.14
Nodes (9): ListarContasFinanceirasUseCase, RemoverContaFinanceiraUseCase, ContaFinanceiraRepositoryPort, DeletarContaFinanceiraUseCaseTest, ExtendWith, Test, ExtendWith, Test (+1 more)
...
Cohesion: 0.12
Nodes (8): BuscarResumoPeriodoUseCase, BuscarTransacaoUseCase, CriarTransacaoUseCase, Transactional, EstornarTransacaoUseCase, Transactional, TransacaoInvalidaException, TransacaoRepositoryPort
...
Cohesion: 0.28
Nodes (8): GlobalExceptionHandler, ResponseEntity, ContaFinanceiraInvalidaException, CredenciaisInvalidasException, ExceptionHandler, MaxUploadSizeExceededException, RestControllerAdvice, TransacaoNaoEncontradaException
...
Cohesion: 0.16
Nodes (9): trim(), Component, Override, SessaoTokenFilter, SessaoTokenRepositoryPort, FilterChain, HttpServletRequest, HttpServletResponse (+1 more)
...
Cohesion: 0.16
Nodes (11): TipoTransacao, GASTO, RECEITA, ContaFinanceira, Transacao, Getter, Setter, StatusRevisaoTransacao (+3 more)

### Community 184 - "ExtratosScreen.jsx"
Cohesion: 0.83
Nodes (3): extensao(), EXTENSOES_ACEITAS, ExtratosScreen()

### Community 185 - "ContaFinanceiraRequestDTO"
Cohesion: 0.10
...
Cohesion: 0.27
Nodes (10): ExtratoParser, ImportarExtratoUseCase, Categoria, CategoriaRepositoryPort, ContaFinanceiraRepositoryPort, ExtratoRepositoryPort, TransacaoRepositoryPort, ArmazenamentoArquivoPort (+2 more)

### Community 189 - "SessaoToken"
Cohesion: 0.18
Nodes (4): CredenciaisInvalidasException, Getter, Setter, SessaoToken

### Community 190 - "RegistrarMovimentacaoEconomiaUseCaseTest.java"
Cohesion: 0.29
Nodes (4): RegistrarMovimentacaoEconomiaUseCase, ExtendWith, Test, RegistrarMovimentacaoEconomiaUseCaseTest

### Community 191 - "CategoriaControllerTest"
Cohesion: 0.29
Nodes (5): CategoriaControllerTest, BeforeEach, ExtendWith, MockMvc, Test

### Community 192 - "CsvExtratoParser"
Cohesion: 0.26
Nodes (5): CsvExtratoParser, Component, Override, LancamentoExtraido, CSVRecord
...
Cohesion: 0.17
Nodes (3): Getter, Setter, CodeGenerator

### Community 195 - "Categoria"
Cohesion: 0.29
Nodes (7): Categoria, Getter, Setter, TipoCategoria, AMBOS, GASTO, RECEITA

### Community 196 - "mvnw"
Cohesion: 0.39
Nodes (6): mvnw script, clean(), die(), exec_maven(), set_java_home(), verbose()

### Community 198 - "CategoriaThreshold"
Cohesion: 0.39
...
### Community 202 - "CancelarTransacaoUseCase.java"
Cohesion: 0.33
Nodes (3): MotivoCancelamentoInvalidoException, Getter, Setter

### Community 203 - "OrigemPermitidaCancelamento"
Cohesion: 0.29
Nodes (5): OrigemPermitidaCancelamento, admin, sistema, todos, usuario

### Community 204 - "OverviewScreen.jsx"
Cohesion: 0.29
Nodes (3): PERIODO_LABEL, ranges, TIPO_LABEL

## Knowledge Gaps
- **376 isolated node(s):** `com.enterprise.gustadev:fintech_app`, `PDF`, `CSV`, `TXT`, `XLS` (+371 more)
...
- **Why does `ExtratoParser` connect `ImportarExtratoUseCase.java` to `CsvExtratoParser`, `XlsExtratoParser`, `ListarContasFinanceirasUseCase`, `Bean Config`, `Tipo Job`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `ContaFinanceiraRepositoryPort` connect `CriarTransacaoUseCaseTest.java` to `Categoria Repository Port & Related`, `Categoria Threshold Repository Port`, `Conta Financeira Test`, `Extrato Repository Port & Related`, `TransacaoCanceladaController.java`, `Mock Mvc`, `CancelarTransacaoUseCase.java`, `Transacao Cancelada Repository Port & Related`, `Transacao Repository Port & Related`, `Transactional`, `Conta Financeira Repository Port & Related`, `Notificacao`, `CriarContaFinanceiraUseCaseTest.java`, `Tipo Transacao & Related`, `RegistrarMovimentacaoEconomiaUseCaseTest.java`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `ContaFinanceira` connect `Conta Financeira Test` to `Conta Financeira Controller Test`, `CodeGenerator.java`, `Categoria Repository Port & Related`, `Transactional`, `Mock Mvc`, `Transacao Repository Port & Related`, `Conta Financeira Repository Port & Related`, `CriarTransacaoUseCaseTest.java`, `Conta Financeira Controller & Related`, `CriarContaFinanceiraUseCaseTest.java`, `Tipo Transacao & Related`, `.detectar`, `RegistrarMovimentacaoEconomiaUseCaseTest.java`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **What connects `com.enterprise.gustadev:fintech_app`, `PDF`, `CSV` to the rest of the system?**
